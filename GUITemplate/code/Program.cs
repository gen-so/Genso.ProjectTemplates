    ...
    public class Program
    {
        ...
        private void CalculateEventsButtonClicked(object sender, EventArgs e)
        {
            ...
            bool isEventOptionsValid()
            {
                ...
                isValid = !EqualityComparer<object>.Default.Equals(gui.MainGrid.ViewEventOptions.SelectedLocation, default(object));
                if (!isValid) { gui.ShowPopupMessage("Please select a location!"); return false; }

                isValid = !EqualityComparer<object>.Default.Equals(gui.MainGrid.ViewEventOptions.SelectedPerson, default(object));
        ...
        private void FindEventsButtonClicked(object sender, EventArgs e)
        {
            ...
            bool isFindEventOptionsValid()
            {
                ...
                //check each combo box
                isValid = !EqualityComparer<object>.Default.Equals(gui.MainGrid.FindEventOptions.SelectedLocation, default(object));
                if (!isValid) { gui.ShowPopupMessage("Please select a location!"); return false; }

                isValid = !EqualityComparer<object>.Default.Equals(gui.MainGrid.FindEventOptions.SelectedPerson, default(object));
                if (!isValid) { gui.ShowPopupMessage("Please select a person!"); return false; }
